        ...
        <div class="container">
            <style type="text/css">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="center" style="background-color: #fffefe;" bgcolor="#eeeeee">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:800px;">
                                    ...
                                    <tr>
                                        <td align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                                            ...
                                            <a href="{{ route('index') }}" class="btnRegister btn btn-primary py-3 px-4" type="submit" style="color: #0d0d0d; margin-left: 50px">Trở về trang chủ</a>
                            <a href="{{ route('muangay') }}" class="btnRegister btn btn-primary py-3 px-4" type="submit"style="color: #0d0d0d; margin-left: 200px">Tiếp tục mua sắm</a>
                                        </td>
                                    </tr>
